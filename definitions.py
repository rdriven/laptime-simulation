...
BATTERY_MAX_CHARGING_POWER_TAG = "Maximum battery charge rate (Watts)"
...
HEADER_ROW = [
    ...
    M_TAG, MAXIMUM_ALLOWABLE_VEHICLE_MASS_TAG, BATTERY_MAX_CHARGING_POWER_TAG,
    ...
    MAX_VEHICLE_WEIGHT_RATIO_TAG, C_W_A_LAPTIMESIM_TAG,
    ...
    FRONT_TIRE_DMUY_DFZ_TAG, F_ROLL_TAG
]
